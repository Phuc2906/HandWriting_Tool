...
import argparse
import os
from src.model_crnn import CRNN, CTCLoss
...
def main():
    ...
    parser.add_argument('--image_dir', help='Directory containing images (optional if full paths in CSV)')
    ...
    # Dataset
    dataset = HandwritingDataset(args.train_csv, args.image_dir)
